...
sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"下一页",sPrevious:"上一页"},sEmptyTable:"这张表格上没有数据",sInfo:"此页正在显示第_START_ 到第 _END_ 个人的数据，总人数 _TOTAL_ 人。",sInfoEmpty:"此页没数据啦",sInfoFiltered:"(数据总数为 _MAX_ total 人)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"每页显示 _MENU_ 个人的数据",sLoadingRecords:"少女祈祷中...",sProcessing:"少女依旧祈祷中...",sSearch:"搜索:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"没有符合条件的结果"},
...
" ui-corner-tl ui-corner-tr",sJUIFooter:Yb+" ui-corner-bl ui-corner-br"});var Nb=m.ext.pager;h.extend(Nb,{simple:function(){return["上一页","下一页"]},full:function(){return["first","上一页","下一页","last"]},numbers:function(a,b){return[ia(a,b)]},simple_numbers:function(a,b){return["上一页",ia(a,b),"下一页"]},full_numbers:function(a,b){return["first","上一页",ia(a,b),"下一页","last"]},first_last_numbers:function(a,b){return["first",ia(a,b),"last"]},_numbers:ia,numbers_length:7});h.extend(!0,m.ext.renderer,
{pageButton:{_:function(a,b,c,d,e,f){var g=a.oClasses,j=a.oLanguage.oPaginate,i=a.oLanguage.oAria.paginate||{},m,l,p=0,r=function(b,d){var k,t,u,s,v=function(b){Va(a,b.data.action,true)};k=0;for(t=d.length;k<t;k++){s=d[k];if(h.isArray(s)){u=h("<"+(s.DT_el||"div")+"/>").appendTo(b);r(u,s)}else{m=null;l="";switch(s){case "ellipsis":b.append('<span class="ellipsis">&#x2026;</span>');break;case "first":m=j.sFirst;l=s+(e>0?"":" "+g.sPageButtonDisabled);break;case "上一页":m=j.sPrevious;l=s+(e>0?"":" "+
